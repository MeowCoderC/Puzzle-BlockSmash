namespace BlockSmash
{
    ...
    public class LevelManager : MonoBehaviour
    {
        ...
        [SerializeField] private ThemeColor currentTheme;

        [Header("Components")] 
        [SerializeField] private BoardController boardController;
        [SerializeField] private ShapeHandManager handManager;
        ...
        public void LoadLevel(int index)
        {
            ...
            if (this.handManager != null)
                this.handManager.SetupHand(this.currentLevelData, this.currentTheme);
        }
